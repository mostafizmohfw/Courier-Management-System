    ...
    <div class="dashboard-bg  w-full">
        <div class="bg-[#100937] py-8 pl-9 pr-4 min-h-[206px]">
            ...
            <ul class="flex items-center">
                <li class="mr-[20px] inline-block text-[#A2A6AA] text-sm"><a href="{{ route('shipment') }}">Shipments</a>
                </li>
                <li class="mr-[20px] inline-block"><img src="{{ asset('assets/img/Iconly/Light/breadcumb-arrow.svg') }}"
                        alt=""></li>
                <li class="text-sm text-white mr-[20px] inline-block">Add Shipment</li>
            </ul>
        </div>

        <div class="bg-white mx-8 px-7 py-7 -mt-[85px]">
            <div class="flex items-center mb-7">
                <h1 class="mr-2 text-lg font-bold">New Shipment</h1>
            ...
            <div class="">
                <form class="w-full min-w-max">
                    <div class="w-full mb-8 ">
                        ...
                        <input
                            class="appearance-none block placeholder: w-full  border border-[#DCE4E8] py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white h-[60px]"
                    ...
                    <div class="flex -mx-3 mb-8">
                        <div class="w-full md:w-1/2 px-3 ">
                            ...
                            <input
                                class="appearance-none block  placeholder: w-full text-bold border border-[#DCE4E8] py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white h-[60px]"
                                id="grid-first-name" type="text" placeholder="248438635">
                        </div>
                        <div class="w-full md:w-1/2 px-3">
                            <label class="block  tracking-wide  text-gray-500 text-bold text-xs font-bold mb-2"
                                for="grid-last-name">Booking ID</label>
                            <input
                                class="appearance-none block  placeholder: w-full text-bold border border-[#DCE4E8] py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white h-[60px]"
                    ...
                    <div>
                        ...
                        <div class="flex mt-8">
                            <button class="px-8 text-white font-bold py-3 base-color mr-6">Add Shipment</button>
